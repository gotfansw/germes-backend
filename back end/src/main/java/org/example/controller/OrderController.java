...
public class OrderController {
    ...
    public String payPage(@PathVariable Long id) {
        OrderDTO order = orderService.updatePaymentStatus(id, PaymentStatus.PAID);
        ...
        String html = "<!doctype html>" +
                ...
                ".ok{font-size:56px;line-height:1;color:#16a34a;margin-bottom:12px}" +
                ...
                "<p>Заказ успешно оплачен. Можно возвращаться в магазин.</p>" +
                "<div class=\"meta\">" +
                "<p><b>Заказ:</b> #" + order.getId() + "</p>" +
                "<p><b>Квитанция:</b> " + safe(order.getReceiptNumber()) + "</p>" +
                "<p><b>Трек-номер:</b> " + safe(order.getTrackNumber()) + "</p>" +
                "</div>" +
                "</div>" +
                "</body>" +
                "</html>";
